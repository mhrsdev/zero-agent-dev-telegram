-- GENERATED from 0012_remediation_integration_evidence.sql by scripts/gen_pg_migrations.py.
...
CREATE TABLE IF NOT EXISTS integration_worktrees (
    ...
    updated_at      TEXT NOT NULL DEFAULT (to_char(clock_timestamp(), 'YYYY-MM-DD"T"HH24:MI:SS.US"Z"'))
);
